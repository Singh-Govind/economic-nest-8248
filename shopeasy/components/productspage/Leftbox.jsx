...
const LeftBox = () => {
    ...
    const getData = async () => {
        await axios
            .get("https://vercel.com/singh-govind/economic-nest-8248/api/products/category")
            .then((res) => {
    ...
    const brandFilterData = async (brandName) => {
        await axios
            .get(`https://vercel.com/singh-govind/economic-nest-8248/api/products/category?brand=${brandName}`)
            .then((res) => {
                setProducts(res.data.data);
            });
    };
    ...
    const filterByPrice = async (el) => {
        ...
        await axios
            .get(`https://vercel.com/singh-govind/economic-nest-8248/api/products/category?price=${price}`)
            .then((res) => {
    ...
    const filterByType = async (type) => {
        ...
        await axios
            .get(`https://vercel.com/singh-govind/economic-nest-8248/api/products/category?type=${type}`)
            .then((res) => {
                console.log(res.data)
                setProducts(res.data.data);
            });
    ...
    const filterByPriceRange = async (cmd) => {
        if (cmd == "gt") {
            let price = 8000;
            await axios
                .get(`https://vercel.com/singh-govind/economic-nest-8248/api/products/category?price=${price}&cmd=${cmd}`)
                .then((res) => {
                    setProducts(res.data);
                });
        }
            ...
            await axios
                .get(`https://vercel.com/singh-govind/economic-nest-8248/api/products/category?price=8000&cmd=${cmd}`)
                .then((res) => {
            ...
            .get(`https://vercel.com/singh-govind/economic-nest-8248/api/products/category?price=5000&cmd=${cmd}`)
            .then((res) => {
                setProducts(res.data)
            });
    };

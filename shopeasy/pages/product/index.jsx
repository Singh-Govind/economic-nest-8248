    ...
    <>
      ...
      <Flex m="auto" width={["100%", "70%"]} mt="20">
        ...
        >
          ...
          <Button ml="2" colorScheme="green" h="7">
            {localData.ratings} <AiOutlineStar />
          </Button>
          <Text fontSize="2xl">₹ {localData.discount_price}</Text>
          <Flex m="auto" w="26%">
            <Text textDecoration="line-through" color="orange.300">
              ₹ {localData.price}{" "}
            </Text>
            <Text>(51% OFF)</Text>
          </Flex>
          ...
          <Box>
            <Tooltip
              hasArrow
              label='Shoulder- 15.5"  |  Chest- 38"'
              bg="red.600"
            >
              <Button
                ml="1"
                onClick={selectSizefunc1}
                bgColor={size1 ? "teal" : ""}
                borderRadius="50%"
              >
                XS
            ...
            <Tooltip
              hasArrow
              label='Shoulder- 16.5"  |  Chest- 40"'
              bg="red.600"
            >
              <Button
                ml="1"
                onClick={selectSizefunc2}
                bgColor={size2 ? "teal" : ""}
                borderRadius="50%"
              >
                S
            ...
            <Tooltip
              hasArrow
              label='Shoulder- ml="1" 17.5"  |  Chest- 42"'
              bg="red.600"
            >
              <Button
                ml="1"
                onClick={selectSizefunc3}
                bgColor={size3 ? "teal" : ""}
                borderRadius="50%"
              >
                M
            ...
            <Tooltip
              hasArrow
              label='Shoulder- 18.5"  |  Chest- 44"'
              bg="red.600"
            >
              <Button
                ml="1"
                onClick={selectSizefunc4}
                bgColor={size4 ? "teal" : ""}
                borderRadius="50%"
              >
                L
            ...
            <Tooltip
              hasArrow
              label='Shoulder- 19.5"  |  Chest- 46"'
              bg="red.600"
            >
              <Button
                ml="1"
                onClick={selectSizefunc5}
                bgColor={size5 ? "teal" : ""}
                borderRadius="50%"
              >
                XL
          ...
          <Text fontSize="2xs">
            Compare {localData.brand} size with other brand sizes
          </Text>
          ...
          <Box>
            ...
            {isDelivery && (
              <Box p="20px" m="6" bg="teal.100" rounded="md" shadow="md">
          ...
          <Box>
            <Button
              ...
              className={styles.singleProductAddtoCart}
              boxShadow="rgba(0, 0, 0, 0.35) 0px 5px 15px"
              mt="5"
              w="70%"
              color="white"
            ...
            >
              {" "}
              <RiShoppingBagLine /> <Text ml="2">Add to Bag</Text>{" "}
            </Button>
            <Drawer
              isOpen={isOpen}
              placement="right"
                ...
                <DrawerBody>
                  <Box>
                    {cart.map((item) => (
                      ...
                      >
                        ...
                        <Box>
                          ...
                          <Text fontSize="20" color="red.500" ml="10%" mt="2">
                            {item.discount_price}
                          </Text>
                          <Text
                          ...
                          <Button bgColor="red.200" ml="2" color="red">
                            Delete
                          </Button>
                        </Box>
                      </Flex>
                    ...
                    <Flex>
                      ...
                      <Text ml="2" color="teal" fontSize="2xl" fontWeight="500">
                        ₹ {localData.discount_price}
                      </Text>
                    </Flex>
                  </Box>
                </DrawerBody>
          ...
          >
            {" "}
            <RiShoppingBagLine /> <Text ml="2">Save to Wistlist</Text>{" "}
          </Button>
      ...
      <Text fontSize="2xl" textAlign="center" mt="20" fontWeight="500">
        About the Company
      </Text>
      <Box w="80%" m="auto" mt="8" color="gray">
        Explore exclusive athleisure clothing for men and women on AJIO, an
        in-house brand of Reliance Trends. From shift dresses and high-neck
        sweatshirts for women to striped polo t-shirts and cotton cargo shorts
        for men, sporty casuals get a boost of style. + Shirts & tops for women
        Add funkiness to basics with the unique designs . Look smart in stripes,
        wearing a top with mesh sleeves. To stand out in a crowd, pick a bolder
        style such as a hooded top with drop sleeves or a typographic print top
        with raglan sleeves. Keep up with the trends in a cold-shoulder top with
        panelled sleeves or a graphic print top with bell sleeves.
        <Box>
          Coordinate your look with chic outerwear such as sweaters and
          sweatshirts . This company has some smart options, including
          colourblock sweaters with ribbed hem, all-over print sweatshirts,
          speckled crew-neck pullovers and more.
        </Box>
        Tshirts for men Every man has a unique sense of style. That’s why the
        brand has a versatile collection of men’s T-shirts . For a modern twist
        to a classic style, you can choose polo T-shirts with stripes and
        patterned weave. Add fun to your casual wardrobe with graphic print
        Teamspirit Tshirts in a variety of styles. You can choose from crew
        neck, cut & sew, heathered, Ombre-dyed and more.
      </Box>
